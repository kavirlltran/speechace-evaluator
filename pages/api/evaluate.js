...
export default async function handler(req, res) {
  ...
  form.parse(req, async (err, fields, files) => {
    ...
    // Tạo một FormData mới để gửi tới Speechace API
    ...
    const speechaceUrl = 'https://api.speechace.co/api/scoring/text/v9/json?key=kzsoOXHxN1oTpzvi85wVqqZ9Mqg6cAwmHhiTvv%2FfcvLKGaWgcsQkEivJ4D%2Bt9StzW1YpCgrZp8DsFSfEy3YApSRDshFr4FlY0gyQwJOa6bAVpzh6NnoVQC50w7m%2FYYHA&dialect=en-us&user_id=XYZ-ABC-99001';
